...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-bell me-3"></i>Dashboard</h2>
        </a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">الدليل</h6>
                <h1 class="mb-5">لوحة التحكم</h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="{{route('creatediscount')}}">
                        <div class="service-item text-center pt-3">

                            <div class="p-4">
                                <i class="fa fa-3x fa-plus text-primary mb-4"></i>
                                <h5 class="mb-3">أضافة كوبون</h5>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="{{route('createSubCity')}}">
                        <div class="service-item text-center pt-3">

                            <div class="p-4">
                                <i class="fa fa-3x fa-plus text-primary mb-4"></i>
                                <h5 class="mb-3">أضافة منطقة</h5>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="{{route('createSlide')}}">
                        <div class="service-item text-center pt-3">
                            ...
                            <div class="p-4">
                                <i class="fa fa-3x fa-plus text-primary mb-4"></i>
                                <h5 class="mb-3">أضافة سلايد رئيسي</h5>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="{{route('getcoupon')}}">
                        <div class="service-item text-center pt-3">

                            <div class="p-4">
                                <i class="fa fa-3x fa-plus text-primary mb-4"></i>
                                <h5 class="mb-3">الكوبونات</h5>
