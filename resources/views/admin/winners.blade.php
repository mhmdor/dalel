...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">{{ $coupon->place->name }}</h6>

                <h1 class="mb-5">جائزة بقيمة {{ $coupon->value }}</h1>
            </div>
            <div class="row g-4">
                @foreach ($users as $item)
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">

                        <a href="{{ route('getwinner', $item->id) }}">
