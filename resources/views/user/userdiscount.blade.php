                                    ...
                                    <div class="down-content text-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-6">
                                                <div class="book now">
                                                    ...
                                                    @if ($item->pivot->status == 1)
                                                        <p style="color: green">الكود مستخدم</p>
                                                    @else
                                                        <p style="color: red">الكود غير مستخدم بعد</p>
                                                    @endif
                                            ...
                                            @if ($item->pivot->status == 1)
                                                <div class="col-lg-3 col-6">
                                                    <div class="book now">
                                                        <h5>تاريخ الاستخدام</h5>
                                                        <p>{{ Carbon\Carbon::parse($item->pivot->updated_at)->format('Y-m-d h:i') }}
                                                        </p>
                                                ...
                                                <div class="col-lg-3 col-6">
                                                    <div class="book now">
                                                        ...
                                                        @if ($item->Expiration_date <= $date)
                                                            <p>الكود منتهي الصلاحية</p>
                                                        @else
                                                            <p> {{ Carbon\Carbon::parse($item->Expiration_date)->format('Y-m-d h:i') }}
                                                            </p>
                                                        @endif
